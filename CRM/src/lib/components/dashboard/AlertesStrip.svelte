...
<style>
	...
	:global(.coherence-ui) .section-meta {
		font-size: 12px;
		font-weight: 700;
	}
	.section-h2 {
	...
	.alert-info .alert-icon :global(svg) { color: var(--color-info-deep); }
	...
	.alert-warn .alert-icon :global(svg) { color: var(--color-warning-deep); }
