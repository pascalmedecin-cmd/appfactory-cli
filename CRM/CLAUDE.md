...
- [x] ~~**Aperçu étiquettes campagne : planche A4 portrait + footer sans débordement**~~ - 2026-07-03 (**LIVRÉ PROD** `8c31709`, agent parallèle relu). Modale « Aperçu de la planche » : pages rendues paysage avec grille tassée en bande (aspect-ratio conteneur + height 100 % SVG = résolution circulaire dans le flex, letterboxing) → le SVG porte son ratio A4 portrait intrinsèque (width 100 %, height auto) ; footer flex-wrap, bouton « Télécharger le PDF » plus jamais rogné. CSS scoped uniquement, **PDF intact** (il était correct). QA 2522 verts, svelte-check 0/0. **Réserve : non vérifié navigateur - validation visuelle Pascal à l'ouverture de la modale.**
