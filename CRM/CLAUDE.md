...
- **Bloc #1** - Refonte page Aide CRM 3 niveaux (session dédiée, SUPERVISÉ • xhigh) — seule tâche en file. Spec figée `notes/refonte-aide-2026-05-12/spec.md`. H-28/M-29 délégués à cette refonte.
