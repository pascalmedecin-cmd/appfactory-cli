...
- **État : Run 1, Run 2 ET Run 3 DÉPLOYÉS EN PROD.** Run 3 (2026-07-16) : import de liste (source `manuel`) + onglet « Ma liste » + D3/D4 (D4 appliquée prod, merge `4e3f149`, smoke vert, 0 C/H). **Reste = sign-off visuel Pascal, sur la prod directement** (personne ne l'utilise encore). V6 Hunter / V7 Pingen en attente comptes Pascal. Détail → `docs/ATELIER-209-SUIVI.md` + [[project_atelier_209_run3_import_liste_2026-07-16]].
