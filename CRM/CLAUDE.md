...
### 1. Tâche #4 Refonte page Aide CRM from scratch [SUPERVISÉ • xhigh • session dédiée]
...
**Prérequis** : ✓ levé — cascade audit 360 **entièrement fermée** (V1→V3b mergées S178→S180, 2026-05-10..12). Techniquement indépendante (fichier `/aide/+page.svelte` non touché par les vagues). C'est la tâche prioritaire.
