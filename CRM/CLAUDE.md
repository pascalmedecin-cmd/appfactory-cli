...
- [ ] **[EXÉCUTABLE]** Cohérence UI **d** (grille 8px : page-gutter tokenisé, largeur ancrée à gauche, Veille→gauche, rythme vertical) = dernier axe de l'increment. Page par page derrière `ff_ui_coherence`, QA OFF/ON DOM. Le plus structurel/risqué (layout des 10 pages) → lot dédié. → `docs/COHERENCE-UI-BANDEAU.md`.
