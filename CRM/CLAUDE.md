...
**Dernière mise à jour :** 2026-07-17 (cohérence UI - **increment b PART 1 livré** `3976d6e` poussé + déployé prod (Ready), flag `ff_ui_coherence` OFF : boutons→`.ws-btn` sur 5 pages + Badge/SourcePill radius-full + SearchInput 40px. QA OFF/ON prouvée au DOM, revue adversariale 5 lentilles/7 findings dont 2 régressions OFF. Vitest 2827). **Prochain bug :** #001.
