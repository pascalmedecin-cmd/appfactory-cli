...
- [x] ~~**Bump TypeScript 6**~~ - LIVRÉ 26/06 (`658a8f7`) : 5.9.3 → 6.0.3. Compatible peers ; **0 erreur de type** remontée (codebase déjà conforme), 0 correction nécessaire. svelte-check 0/0, 2310 tests, build OK.
...
- [x] ~~**Cron veille avancé 06:27 → 02:27 UTC** (04:27 suisse)~~ - 2026-06-26 (`.github/workflows/cron-veille.yml`, branche prod, **pas encore poussé**) : pour absorber le retard scheduler GitHub (2-4h) et faire atterrir le brief le matin (~06-08h suisse) au lieu de midi/soir. Minute :27 gardée (anti-congestion). Filet du soir 17:27 inchangé. **Prend effet à la reconciliation `main`** (GitHub lit le planning sur la branche par défaut) → live pour W27.
- [x] ~~**Bump TypeScript 6**~~ - 2026-06-26 (`658a8f7`, branche prod, **pas encore poussé**) : 5.9.3 → 6.0.3, upgrade propre (0 erreur, codebase déjà conforme). svelte-check 0/0, 2310 tests, build OK.
