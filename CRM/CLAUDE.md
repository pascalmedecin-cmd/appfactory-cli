...
**Derniere mise a jour :** 2026-05-07 (S174 xhigh : Migration AppFactory restructure Voie B - rename template/ → CRM/ + retrait wizard méta + Vercel PATCH rootDirectory + fix watcher cockpit régression S173 + fix UI cockpit SUBPROJECTS_CONFIG ajout Consulting/AppWizard. 2 commits push origin/main appfactory-cli : `cd85a94` + `7cdcf29`. 5 commits méta `~/.claude` : `184ec73` + `e4db2e3` + `a759b4b` + `2317ebb` + `2c5bc4b`. Tag rollback `pre-voie-b-2026-05-07`. Tests verts : Build CRM 10.74s, svelte-check 129/33 baseline strict, Vitest 666/666, Build Formation 1.84s, Tests cockpit 579/579. Vercel prod Ready 45s, smoke live filmpro-crm.vercel.app HTTP 303 → /login HTTP 200 OK.)
**Derniere revue /optimize :** 2026-04-05
**Prochain bug :** #001
**Session courante :** Session 174 (CRM, 2026-05-07, `/effort xhigh`, Migration Voie B + fix UI cockpit subprojects).
**Sessions précédentes (condensé)** - détail S165-S174 : `archive/2026-05-06-sessions.md` + S174 dans Livré ci-dessous. Détail S122-S125 : `archive/2026-04-28-sessions.md`. Détail S78-S79 : `archive/decisions-sessions-78-79.md`. Détail S70-S77 : `archive/decisions-sessions-70-77.md`. Détail S80-S107 : `Formation/CLAUDE.md` (sous-projet autonome).
