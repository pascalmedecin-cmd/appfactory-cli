...
**Prochaine attaque** : pas de gros chantier. Bloc 1 (merge → `main`) **livré** 2026-06-07. Bloc 2 (copy empty Prospection) **livré + DÉPLOYÉ PROD** 2026-06-07 (`a2dbe62`, deploy `n7qrsvi6f`, alias canonique `filmpro-portail.vercel.app`, smoke prod authentifié OK : HTTP 200 + nouvelle copy « Rechercher une entreprise » live, 0 résidu ancien wording). `main` = prod. Reliquat ouvert : onglets SIMAP/RegBL encore affichés post-V5 (finding tracé Bloc 2) → relève de la « Cascade gabarit /prospection [à re-cadrer post-V5] ».
