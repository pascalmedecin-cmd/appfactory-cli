...
INSERT INTO prospect_leads (id, source, source_id, raison_sociale, canton, telephone, secteur_detecte, score_pertinence, statut, marque) VALUES
  -- FilmPro
  ('11111111-0000-0000-0000-0000000000f1', 'google_places', 'gp-fp-001', 'Regie du Molard SA',        'GE', '+41 22 555 20 01', 'Regie',        8, 'a_contacter', 'filmpro'),
  ('11111111-0000-0000-0000-0000000000f2', 'zefix',         'ide-fp-002', 'Bureau technique Jaquet',  'VD', NULL,               'Ingenierie',   6, 'a_contacter', 'filmpro'),
  ('11111111-0000-0000-0000-0000000000f3', 'search_ch',     'sc-fp-003', 'Renovation Genevoise Sarl', 'GE', '+41 22 555 20 03', 'Renovation',   5, 'vide',        'filmpro'),
  ('11111111-0000-0000-0000-0000000000f4', 'google_places', 'gp-fp-004', 'Climatisation Leman SA',    'VD', '+41 21 555 20 04', 'CVC',          4, 'vide',        'filmpro'),
  ('11111111-0000-0000-0000-0000000000f5', 'zefix',         'ide-fp-005', 'Toitures Fribourg SA',      'FR', NULL,               'Construction', 3, 'ecarte',      'filmpro'),
  -- LED Studio
  ('11111111-0000-0000-0000-0000000000e1', 'google_places', 'gp-led-001', 'Palexpo Concept Events',   'GE', '+41 22 555 30 01', 'Evenementiel', 9, 'a_contacter', 'led'),
  ('11111111-0000-0000-0000-0000000000e2', 'search_ch',     'sc-led-002', 'Vitrine Design Sarl',       'VD', '+41 21 555 30 02', 'Retail',       7, 'a_contacter', 'led'),
  ('11111111-0000-0000-0000-0000000000e3', 'google_places', 'gp-led-003', 'Neon Craft Geneve',         'GE', '+41 22 555 30 03', 'Enseignes',    6, 'vide',        'led'),
  ('11111111-0000-0000-0000-0000000000e4', 'zefix',         'ide-led-004', 'Montage Expo Rapide SA',   'GE', NULL,               'Stands',       5, 'vide',        'led'),
  ('11111111-0000-0000-0000-0000000000e5', 'search_ch',     'sc-led-005', 'Salon Auto Riviera',        'VS', '+41 27 555 30 05', 'Salons',       4, 'ecarte',      'led');
...
INSERT INTO prospect_leads (id, source, source_id, raison_sociale, canton, secteur_detecte, score_pertinence, statut, marque) VALUES
  ('11111111-0000-0000-0000-0000000000f9', 'zefix', 'ide-commun-999', 'Groupe Transverse SA', 'GE', 'Regie',        6, 'vide', 'filmpro'),
  ('11111111-0000-0000-0000-0000000000e9', 'zefix', 'ide-commun-999', 'Groupe Transverse SA', 'GE', 'Evenementiel', 6, 'vide', 'led');
...
INSERT INTO opportunites (id, titre, etape_pipeline, prospect_lead_id, marque) VALUES
  ('seed-opp-fp-01', 'Regie du Molard SA',       'identification', '11111111-0000-0000-0000-0000000000f1', 'filmpro'),
  ('seed-opp-fp-02', 'Bureau technique Jaquet',  'identification', '11111111-0000-0000-0000-0000000000f2', 'filmpro'),
  ('seed-opp-led-01', 'Palexpo Concept Events',  'identification', '11111111-0000-0000-0000-0000000000e1', 'led'),
  ('seed-opp-led-02', 'Vitrine Design Sarl',     'identification', '11111111-0000-0000-0000-0000000000e2', 'led');
...
INSERT INTO campagnes (id, nom, couleur, statut, marque) VALUES
  ('22222222-0000-0000-0000-0000000000f1', 'Regies Geneve T4',      'c1', 'en_cours', 'filmpro'),
  ('22222222-0000-0000-0000-0000000000f2', 'Architectes Vaud',      'c3', 'active',   'filmpro'),
  ('22222222-0000-0000-0000-0000000000e1', 'Enseignes Geneve 2026', 'c5', 'en_cours', 'led'),
  ('22222222-0000-0000-0000-0000000000e2', 'Stands Salons Vaud',    'c7', 'active',   'led');

INSERT INTO campagne_groupes (id, campagne_id, nom, marque) VALUES
  ('33333333-0000-0000-0000-0000000000f1', '22222222-0000-0000-0000-0000000000f1', 'Prioritaires', 'filmpro'),
  ('33333333-0000-0000-0000-0000000000e1', '22222222-0000-0000-0000-0000000000e1', 'Salon EPHJ',   'led');

INSERT INTO prospect_lead_campagnes (lead_id, campagne_id, groupe_id, marque) VALUES
  ('11111111-0000-0000-0000-0000000000f1', '22222222-0000-0000-0000-0000000000f1', '33333333-0000-0000-0000-0000000000f1', 'filmpro'),
  ('11111111-0000-0000-0000-0000000000f3', '22222222-0000-0000-0000-0000000000f1', NULL,                                   'filmpro'),
  ('11111111-0000-0000-0000-0000000000f2', '22222222-0000-0000-0000-0000000000f2', NULL,                                   'filmpro'),
  ('11111111-0000-0000-0000-0000000000e1', '22222222-0000-0000-0000-0000000000e1', '33333333-0000-0000-0000-0000000000e1', 'led'),
  ('11111111-0000-0000-0000-0000000000e3', '22222222-0000-0000-0000-0000000000e1', NULL,                                   'led'),
  ('11111111-0000-0000-0000-0000000000e2', '22222222-0000-0000-0000-0000000000e2', NULL,                                   'led');
