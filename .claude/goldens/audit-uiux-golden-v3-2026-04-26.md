# Golden Standard CRM FilmPro — v3 (officialisation correctifs S113)

**Créé** : 2026-04-26
**Source** : v2 (2026-04-25) + officialisation correctifs en cours d'audit
**Supersède** : v2 (correctifs `cellPaddingY 10→12` et `headerHeight 44→48` déjà figés dans v2 source — v3 régularise la règle skill « jamais d'écrasement »)
**Symlink courant** : `.claude/audit-uiux-golden-current.json` → v3
**Changelog v3** : aucun changement fonctionnel vs v2. Snapshot propre pour audit run suivant.
