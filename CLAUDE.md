...
**Derniere mise a jour :** 2026-04-17 (session 79 : S7 ingestion `veille-concurrentielle` + `ai-act-rgpd` - plan parcours marketing terminé, docs-only côté CRM)
...
- **Session 77** (formation-ia, 2026-04-17) : S5 ingestion production lourde - 2 modules longs (J7 `visuels-marketing`, J8 `presentations-pro`) + 8 nouveaux outils (`midjourney`, `adobe-firefly`, `ideogram`, `canva`, `gamma`, `beautiful-ai`, `plus-ai`, `copilot-powerpoint`) + 2 jours + 8 exercices + 19 liens + 8 quiz. Sources VÉRIFIÉES : HubSpot 2026, AI Act Art. 50, C2PA, Adobe Firefly. Gates 0/0.
